                    ...
                    return (
                        <div className="tc ph0 ba bw0 shadow-5 br3 w-50 center backSingleCard">
                            <div className="fontSingleCard">
                                ...
                                <p className="ma2"><strong>Garantia:</strong><input className="pl2 pointer v-mid checkbox" type='checkbox' checked={this.props.selectedCard.garantia} onChange={this.props.handleWarranty}></input></p>
